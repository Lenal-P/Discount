  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        ...
        <button onClick={() => handleClick('+')} style={{ backgroundColor: '#FFE4C9' }}>+</button>
        ...
        <button onClick={() => handleClick('*')} style={{ backgroundColor: '#FFE4C9' }}>x</button>
        <button onClick={() => handleClick('.')} style={{ backgroundColor: '#B7E5B4' }}>.</button>
        <button onClick={() => handleClick('0')}>0</button>
        <button onClick={handleCalculate} style={{ backgroundColor: '#B7E5B4' }}>=</button>
        <button onClick={() => handleClick('/')} style={{ backgroundColor: '#FFE4C9' }}>:</button>
        ...
        <button onClick={handleClear} style={{ backgroundColor: '#FF6868' }}>Cls</button>
        <button onClick={clearHistory} style={{ backgroundColor: '#FF6868' }}>ClsHis</button>
      </div>
